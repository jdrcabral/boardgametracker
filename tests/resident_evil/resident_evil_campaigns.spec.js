...
test('should clear when start new campaign', async ({ page }) => {
  ...
  await page.getByRole('button', { name: 'Add Mission Card' }).first().click()
  await page.locator('#addedMissionCardSelect').selectOption('blue_gem_into_the_tiger_statue')
  await page.getByRole('button', { name: 'Add Mission Card' }).nth(1).click()
...
test('should load map correctly when changing campaign', async ({ page }) => {
  await page.goto('http://localhost:3000/pages/boardgame/residentevil.html')
  await page.getByRole('tab', { name: 'Mansion Map' }).click()
  await expect(page.locator('xpath=//*[@id="1st_Floor_East_A"]')).toBeVisible()
  await expect(page.locator('xpath=/html/body/div/div[4]/div[4]/svg/g/g[3]/g[16]/path')).not.toBeVisible()
  ...
  await page.getByRole('button', { name: 'New Campaign' }).click()
  await page.getByRole('tab', { name: 'Mansion Map' }).click()
  await expect(page.locator('xpath=/html/body/div/div[4]/div[4]/svg/g/g[3]/g[16]')).not.toBeVisible()
  await page.locator('xpath=//*[@id="1st_Floor_West_A"]').click()
  await expect(page.locator('#modalTitle')).toContainText('1st Floor West A')
  await page.getByRole('button', { name: 'Reveal ' }).click()
  await expect(page.locator('xpath=//*[@id="1st_Floor_West_B"]')).toBeVisible()

  await page.getByLabel('Campaign Select').click()
  await page.getByLabel('Campaign Select').selectOption('Game Campaign')
  await page.getByRole('tab', { name: 'Mansion Map' }).click()
  await expect(page.locator('xpath=//*[@id="1st_Floor_West_B"]')).toHaveAttribute('hidden')
  await expect(page.locator('xpath=//*[@id="1st_Floor_East_B"]')).toBeVisible()
  await expect(page.locator('xpath=//*[@id="1st_Floor_East_B"]')).not.toHaveAttribute('hidden')

  await page.getByLabel('Campaign Select').click()
  await page.getByLabel('Campaign Select').selectOption('New Campaign')
  await page.getByRole('tab', { name: 'Mansion Map' }).click()
  await expect(page.locator('xpath=//*[@id="1st_Floor_East_B"]')).toHaveAttribute('hidden')
  await expect(page.locator('xpath=//*[@id="1st_Floor_West_B"]')).toBeVisible()
  await expect(page.locator('xpath=//*[@id="1st_Floor_West_B"]')).not.toHaveAttribute('hidden')
})
