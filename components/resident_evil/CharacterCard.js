    ...
    <div className="col-md-3 col-xs-12">
      <div className="card">
        <div className="card-body">
          ...
          <label htmlFor={`characterKerosene${characterNumber}`} className="form-label">Kerosene</label>
          <input type="number" min="1" max="10" className="form-control" id={`characterKerosene${characterNumber}`} />
